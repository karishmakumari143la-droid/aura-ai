      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-400 tracking-wider">Parallel Multi-Agent Autonomous Core</p>
          </div>
        </button>
